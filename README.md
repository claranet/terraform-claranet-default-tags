...
Use the `default_tags_list` output to set the `tags` parameter of your resources:
...
| <a name="output_default_tags_list"></a> [default\_tags\_list](#output\_default\_tags\_list) | Generated default tags as a list of `key=value` strings. |
